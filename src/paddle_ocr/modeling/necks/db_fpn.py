...
from paddle_ocr.modeling.backbones.det_mobilenet_v3 import SEModule
from paddle_ocr.modeling.necks.intracl import IntraCLBlock
...
class RSEFPN(nn.Module):
    ...
    def forward(self, x):
        ...
        # 原来使用的都是F.upsample，由于pytorch已经弃用，
        # 所以改成了F.interpolate，weights本身是不需要修改就能用的
        # out4 = in4 + F.upsample(
